...
urlpatterns = patterns('',
    ...
    #url(r'^subscribe_ig/(?P<object_id>[-\w]+)/$', insta.views.instagram_subscribe, name='instagram_subscribe'),
    url(r'^subscribe_ig/(?P<object>[-\w]+)/(?P<object_id>[-\w]+)/$', insta.views.instagram_subscribe, name='instagram_subscribe'),
    #url(r'^subscribe_ig/location/(?P<object_id>[-\w]+)/$', insta.views.instagram_subscribe, name='instagram_subscribe'),
    url(r'^delete_tag/(?P<object>[-\w]+)/(?P<object_id>[-\w]+)/$', insta.views.delete_igsubscription, name='delete_igsubscription'),
    url(r'^get_location_details/(?P<location_id>[-\w]+)/$', insta.views.get_location_details, name='get_location_details'),
